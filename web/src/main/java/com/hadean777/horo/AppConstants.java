...
public class AppConstants {
    ...
    //Signs
    public final static String ARIES = "ARIES";
    public final static String TAURUS = "TAURUS";
    public final static String GEMINI = "GEMINI";
    public final static String CANCER = "CANCER";
    public final static String LEO = "LEO";
    public final static String VIRGO = "VIRGO";
    public final static String LIBRA = "LIBRA";
    public final static String SCORPIO = "SCORPIO";
    public final static String SAGITTARIUS = "SAGITTARIUS";
